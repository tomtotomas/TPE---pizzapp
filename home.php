...
list($groupedPizzas, $categories) = $pizzaController->showPizzas();
$GLOBALS['groupedPizzas'] = $groupedPizzas;
...
<html lang="es">
    ...
    <body class="home-b">
        ...
        <?php include 'views/promos.phtml'; ?>

        <?php include 'views/pizzas_list.phtml'; ?>
